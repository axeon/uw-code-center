...
public class CodeTemplateGroup implements DataEntity,Serializable{
	...
	public void setGroupType(int groupType){
		if ((!String.valueOf(this.groupType).equals(String.valueOf(groupType)))) {
			...
			this.UPDATED_INFO.append("group_type:\"" + this.groupType+ "\"=>\""
                + groupType + "\"\r\n");
	...
	public void setGroupName(String groupName){
		if ((!String.valueOf(this.groupName).equals(String.valueOf(groupName)))) {
			...
			this.UPDATED_INFO.append("group_name:\"" + this.groupName+ "\"=>\""
                + groupName + "\"\r\n");
	...
	public void setGroupDesc(String groupDesc){
		if ((!String.valueOf(this.groupDesc).equals(String.valueOf(groupDesc)))) {
			...
			this.UPDATED_INFO.append("group_desc:\"" + this.groupDesc+ "\"=>\""
                + groupDesc + "\"\r\n");
