 ...
 * @author axeon
 */
@TableMeta(tableName="code_crit_log",tableType="table")
@Schema(title = "code关键日志", description = "code关键日志")
public class CodeCritLog implements DataEntity,Serializable{
	...
	private void _INIT_UPDATE_INFO() {
		...
		this.UPDATED_INFO = new StringBuilder("表ops_crit_log主键\"" +
				this.id+ "\"更新为:\r\n");
	}
